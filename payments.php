...
<body class="hold-transition sidebar-mini">
                ...
                <form method="POST" id="pay">
                    ...
                    <div class="modal fade" id="mdpay">
                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" style="margin-left: 40%;"><i class="fa fa-handshake"></i>
                                        Record
                                        Payment</h4>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="col-md-4">
                                        <div class-="form-group">
                                            <label >Type</label>
                                            <select name="rtype" class="form-control tftype">
    ...
    <div class="card">
        <div class="card-header">
            ...
            echo $ml; ?>" class="btn btn-primary btn-sm"> <i class="fa fa-chart-line"></i> Statistics </a></h3>
            <?php
            ...
            <a href="#" style="margin-left:10px;" class="btn btn-primary btn-sm"><i class="fa fa-print"></i>
                Statements</a>

            <button class="btn btn-primary btn-sm" style="float:right;" data-toggle="modal" data-target="#mdpay"><i
                                ...
                                <td class="tdedit">
                                    <a class='btn btn-primary btn-sm'
                                        ...
                                        class="text-muted tdedit" data-toggle="tooltip" title="Generate receipt"><i
                                            class="fa fa-print"></i> </a> <a class=" btn btn-danger btn-sm tdedit"
                                        data-toggle="modal" data-target="#mdquestion" data-toggle="tooltip"
                                        title="Delete Payment"><i class="fa fa-times"></i> </a> <a
                                        class="btn btn-warning btn-sm rfbt" data-toggle="modal" data-target="#rfd"
                                        data-toggle="tooltip" title="Refund"><i class="fa fa-retweet"></i></a>
