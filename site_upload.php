...
<head>
  ...
  <title>Site Files | Manage files | Upload files </title>
      ...
      <section class="content">
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header" style="background-color:#343A40;">
                <h4 class="modal-title" style="color: white;"><i class="fa fa-upload" style="color: white;"></i> Upload</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
                ...
                <div class="col-lg-12">
                  ...
                  <div class="panel" style="border-style:dotted; border-radius:10px;">
                    <div class="image_upload_div">
                      <form action="save_image.php" class="dropzone">
                        <div class="dz-message">
                          Drop files here or click to upload. <i class="text-muted fa fa-upload"></i><br>
                          <small class="text-muted">Accepted files: images not more than 4MB</small>
                        </div>
        ...
        <div class="card">
          <div class="card-header">
            ...
            <button class="btn btn-primary btn-sm"  style="float:right;" data-toggle="modal" data-target="#mdpay"><i class="fa fa-plus"></i> Upload </button>
          </div>
          <div class="card-body">
